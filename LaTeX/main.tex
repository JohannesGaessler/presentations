...
\affiliation{\textsuperscript{1}\textit{Department of Experimental Particle Physics (ETP), Karlsruhe Institute of Technology, Karlsruhe, Germany}} % Author affiliation
...
\input{Parts/02_monte_carlo.tex}
\input{Parts/03_gpu_architecture.tex}
\input{Parts/04_gpu_programming.tex}
\input{Parts/05_benchmark.tex}
